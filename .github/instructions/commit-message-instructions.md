...
6. **No AI signatures** — do not append any AI-generated trailer, co-authorship line, or signature (e.g. `Co-authored-by: Claude`, `Generated by: GitHub Copilot`) to the commit message.
